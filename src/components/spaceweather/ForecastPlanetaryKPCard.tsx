...
const dataURL = `${NOAA_BASE_URL}/products/noaa-planetary-k-index-forecast.json`;
...
const ForecastPlanetaryKPCard: React.FC<ForecastPlanetaryKPCardProps> = (
  props,
) => {
  ...
  const updateData = () => {
    axios.get(dataURL).then((res) => {
      let dataItems = res.data
        .slice(1)
        .filter((dataItem: any) => dataItem[2] !== 'observed');
