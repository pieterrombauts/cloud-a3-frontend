...
interface PlanetaryKPCardProps {}

const dataURL = `${NOAA_BASE_URL}/products/noaa-planetary-k-index.json`;
...
const PlanetaryKPCard: React.FC<PlanetaryKPCardProps> = (props) => {
  ...
  return <ChartCard type="bar" options={options} data={data} />;
};

export default PlanetaryKPCard;
