...
const dataURL = "https://services.swpc.noaa.gov/json/goes/primary/integral-electrons-6-hour.json";
    ...
    axios.get(dataURL).then((res) => {
      ...
      if (Array.isArray(dataItems) && dataItems.length > 0) {
        let newData: ChartData = {
          labels: dataItems.map((dataItem: any) => (DateTime.fromISO(dataItem.time_tag).toJSDate())),
          datasets: [{
            label: ">= 2 MeV",
